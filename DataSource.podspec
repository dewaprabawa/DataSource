...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.1"
  spec.summary      = "A short description of DataSource."
  ...
  spec.description  = <<-DESC
                  this pod is for a study purpose.
                   DESC

  spec.homepage     = "https://github.com/dewaprabawa/DataSource.git"
  ...
  spec.source       = { :git => "https://github.com/dewaprabawa/DataSource.git", :tag => "#{spec.version}" }
